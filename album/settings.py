...
SECRET_KEY = 'django-insecure-w$)29o2i3_#etr26df73t040++ojo028!vt2*c3gn@_8b-i8o5'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['album-mundial-salvador.herokuapp.com','127.0.0.1', 'localhost']
...
# en el caso de usar un correo coorporativo consultar con el administrador
EMAIL_PORT = 587
EMAIL_USE_TLS = True
# Para poner prefijo en el titulo del correo electronico
EMAIL_SUBJECT_PREFIX = 'PROYECTO ALBUM '

# Esta variable sirve para django rest framework
REST_FRAMEWORK = {
